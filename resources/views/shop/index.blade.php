					...
					if (typeof window.jQuery !== 'undefined') {
						...
						jQuery(document).ready(function($) {
							...
							var slider = $('#vegas-slider'),
								slides = [{
										name: "img 1",
										src: "{{ asset('assets/images/home_img/img_3.jpg') }}"
									},
									{
										name: "img 2",
										src: "{{ asset('assets/images/home_img/img_2.jpg') }}"
									},
									{
										name: "img 3",
										src: "{{ asset('assets/images/home_img/img_1.jpg') }}"
									}
								],
							...
							slider.vegas({
								...
								delay: 5000,
								slides: slides,
								overlay: "{{ asset('assets/images/home_img/overlays/05.png') }}",
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-12 col-md-10 col-xl-12">
						<div class="__name">AGRIDEV</div>

						<h2 class="__title text-white">Compagnie agricole et d'elevage moderne</h2>
						...
						<p class="text-center mt-5 mt-md-10">
							<span class="d-none d-sm-block"><a class="custom-btn custom-btn--big custom-btn--style-3" href="#offreSpecial">Decouvrez</a></span>

							<!--<span class="d-block d-sm-none"><a class="custom-btn custom-btn--small custom-btn--style-3" href="#">Decouvrez</a></span>-->
						</p>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-12 col-md col-lg-9 col-xl-8">
						...
						<h2 class="__title text-white">Les meilleurs Moisson <br><span>Au monde</span></h2>
						...
						<!--<p class="mt-5 mt-md-10">
							<span class="d-none d-sm-block"><a class="custom-btn custom-btn--big custom-btn--style-3" href="#">Decouvrez</a></span>
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-12 col-md-12 col-xl-12">
						...
						<h2 class="__title text-white" style="font-size: 7rem">Un <span style="color: #fcdb5a">Elevage</span> de premiere classe</h2>

						<p class="text-center mt-5 mt-md-10">
							<span class="d-none d-sm-block"><a class="custom-btn custom-btn--big custom-btn--style-3" href="#aProposDagridev">Qui sommes nous</a></span>
...
<main role="main">
	...
	<!-- start section -->
	<section id="offreSpecial" class="section">
		<div class="container">
			<div class="section-heading section-heading--center" data-aos="fade">
				<h2 class="__title"><span>Offres</span> Special</h2>
					...
					<div class="row">
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="__item  text-center" data-aos="fade" data-aos-delay="100" data-aos-offset="100">
								<i class="__ico">
									<img class="img-fluid  lazy" src="{{ asset('assets/images/blank.gif') }}" data-src="{{ asset('assets/images/feature_img/1.png') }}" alt="demo" />
								</i>

								<h5 class="__title">Elevage</h5>
							</div>
						</div>
						<!-- end item -->
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="__item  text-center" data-aos="fade" data-aos-delay="200" data-aos-offset="100">
								<i class="__ico">
									<img class="img-fluid  lazy" src="./assets/images/blank.gif" data-src="./assets/images/feature_img/2.png" alt="demo" />
								</i>

								<h5 class="__title">Défrichage</h5>
							</div>
						</div>
						<!-- end item -->
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="__item  text-center" data-aos="fade" data-aos-delay="300" data-aos-offset="100">
								<i class="__ico">
									<img class="img-fluid  lazy" src="./assets/images/blank.gif" data-src="./assets/images/feature_img/3.png" alt="demo" />
								</i>

								<h5 class="__title">Culture Fruitières</h5>
							</div>
						</div>
						<!-- end item -->
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="__item  text-center" data-aos="fade" data-aos-delay="400" data-aos-offset="100">
								<i class="__ico">
									<img class="img-fluid  lazy" src="./assets/images/blank.gif" data-src="./assets/images/feature_img/4.png" alt="demo" />
								</i>

								<h5 class="__title">Culture d'épice</h5>
							</div>
						</div>
						<!-- end item -->
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="__item  text-center" data-aos="fade" data-aos-delay="500" data-aos-offset="100">
								<i class="__ico">
									<img class="img-fluid  lazy" src="./assets/images/blank.gif" data-src="./assets/images/feature_img/5.png" alt="demo" />
								</i>

								<h5 class="__title">Culture Alimentaire</h5>
							</div>
						</div>
						<!-- end item -->
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="__item  text-center" data-aos="fade" data-aos-delay="600" data-aos-offset="100">
								<i class="__ico">
									<img class="img-fluid  lazy" src="./assets/images/blank.gif" data-src="./assets/images/feature_img/6.png" alt="demo" />
								</i>

								<h5 class="__title">Machinerie AGRIDEV</h5>
							</div>
						</div>
						<!-- end item -->
					</div>
	...
	<section class="section section--no-pt section--no-pb">
		<div class="container">
			<div class="special-offer special-offer--style-1" data-aos="zoom-in" data-aos-duration="600" data-aos-offset="70">
				<h2 class="text text-center lazy" data-src="./assets/images/special_offer_text_bg.jpg">Agridev une reponse a
					la securite Alimentaire</h2>
			</div>
		</div>
	</section>
	<!-- end section -->
	...
	<section class="section">
		<div class="d-none d-lg-block">
			<img id="bg-img-1" class="img-fluid lazy" src="./assets/images/blank.gif" data-src="./assets/images/agro.png" alt="demo" />
			<style type="text/css">
				#bg-img-1 {
					position: absolute;
					top: 50%;
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-12 col-lg-4">
					<div id="aProposDagridev" data-aos="fade-left" data-aos-delay="400" data-aos-duration="500" ddata-aos-offset="100">
						<div class="section-heading">
							<h2 class="__title">À Propos D'AGRIDEV <span>Compagnie agricole et d'elevage moderne</span></h2>
						</div>

						<p class="d-none d-sm-block">
							<a class="custom-btn custom-btn--medium custom-btn--style-1" href="./views/about.php">En savoir plus</a>
						</p>
					</div>
				</div>
				...
				<div class="col-12 col-lg-4  text-center">
					<div data-aos="fade-up" ddata-aos-duration="600" data-aos-offset="100">
						<img class="img-fluid  lazy" src="./assets/images/blank.gif" data-src="./assets/images/img_1.png" alt="demo" />
					</div>
				</div>
				...
				<div class="col-12 col-lg-4">
					<div data-aos="fade-right" data-aos-delay="400" data-aos-duration="500" ddata-aos-offset="100">
						...
						<p class="d-sm-none">
							<a class="custom-btn custom-btn--medium custom-btn--style-1" href="#">En savoir plus</a>
						</p>
					</div>
				</div>
			</div>
							...
							<div class="__item" data-aos="zoom-in" data-aos-duration="350" data-aos-delay="150">
								<div class="d-table">
									<div class="d-table-cell align-middle">
										<i class="__ico">
											<img class="img-fluid  lazy" src="./assets/images/blank.gif" data-src="./assets/images/ico/ico_count_1.png" alt="demo" />
										</i>
									</div>
						...
						<div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-3">
							<div class="__item" data-aos="zoom-in" data-aos-duration="350" data-aos-delay="300">
								<div class="d-table">
									<div class="d-table-cell align-middle">
										<i class="__ico">
											<img class="img-fluid  lazy" src="./assets/images/blank.gif" data-src="./assets/images/ico/ico_count_2.png" alt="demo" />
										</i>
									</div>
						...
						<div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-3">
							<div class="__item" data-aos="zoom-in" data-aos-duration="350" data-aos-delay="450">
								<div class="d-table">
									<div class="d-table-cell align-middle">
										<i class="__ico">
											<img class="img-fluid  lazy" src="./assets/images/blank.gif" data-src="./assets/images/ico/ico_count_3.png" alt="demo" />
										</i>
									</div>
						...
						<div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-3">
							<div class="__item" data-aos="zoom-in" data-aos-duration="350" data-aos-delay="600">
								<div class="d-table">
									<div class="d-table-cell align-middle">
										<i class="__ico">
											<img class="img-fluid  lazy" src="./assets/images/blank.gif" data-src="./assets/images/ico/ico_count_4.png" alt="demo" />
										</i>
									</div>
	...
	<section class="section">
		<div class="container">
			<div class="section-heading section-heading--center" data-aos="fade">
				<h2 class="__title">Nous Sommes <span>Partout dans le monde</span></h2>
			...
			<div data-aos="slide-up" data-aos-duration="800" data-aos-offset="50">
				<img class="img-fluid  lazy" src="./assets/images/blank.gif" data-src="./assets/images/img_world_map.png" alt="demo" />
			</div>
		</div>
	</section>
	<!-- end section -->
				...
				<div class="__inner">
					<div class="row">
						...
						<div class="col-12 col-md-7 col-xl-6">
							<div class="__item">
								<div class="__intro-text">
									<div class="row">
										<div class="col-md-11">
											<h2><span>produits</span> AGRIDEV </h2>
											...
											<p>
												<a class="custom-btn custom-btn--medium custom-btn--style-1" href="#">Tout nos produits</a>
											</p>
										</div>
									</div>
								</div>
						...
						<div class="col-12 col-md-5 col-xl-3">
							<div class="__item">
								<figure class="__image">
									<img class="lazy" src="./assets/images/blank.gif" data-src="./assets/images/product-preview_img/1.jpg" alt="demo" />
								</figure>
						...
						<div class="col-12 col-md-4 col-xl-3">
							<div class="__item">
								<figure class="__image">
									<img class="lazy" src="./assets/images/blank.gif" data-src="./assets/images/product-preview_img/2.jpg" alt="demo" />
								</figure>

								<div class="__content">
									<h3 class="__title">Légume</h3>
								</div>
						...
						<div class="col-12 col-md-4 col-xl-3">
							<div class="__item">
								<figure class="__image">
									<img class="lazy" src="./assets/images/blank.gif" data-src="./assets/images/product-preview_img/3.jpg" alt="demo" />
								</figure>

								<div class="__content">
									<h3 class="__title">Bétail</h3>
								</div>
						...
						<div class="col-12 col-md-4 col-xl-3">
							<div class="__item">
								<figure class="__image">
									<img class="lazy" src="./assets/images/blank.gif" data-src="./assets/images/product-preview_img/4.jpg" alt="demo" />
								</figure>

								<div class="__content">
									<h3 class="__title">Volaille</h3>
								</div>
						...
						<div class="col-12 col-xl-6">
							<div class="__item">
								<div class="__content">
									<h2 class="__title"><b></b> Autre <br>produits</h2>
								</div>
						...
						<div class="col-12 col-md-7 col-xl-6 offset-xl-3">
							<div class="__item">
								<figure class="__image">
									<img class="lazy" src="./assets/images/blank.gif" data-src="./assets/images/product-preview_img/5.jpg" alt="demo" />
								</figure>

								<div class="__content">
									<h3 class="__title">Maïs</h3>
								</div>
						...
						<div class="col-12 col-md-5 col-xl-3">
							<div class="__item">
								<figure class="__image">
									<img class="lazy" src="./assets/images/blank.gif" data-src="./assets/images/product-preview_img/6.jpg" alt="demo" />
								</figure>

								<div class="__content">
									<h3 class="__title">Épice</h3>
								</div>
	...
	<!-- start section -->
	<section class="section section--review  lazy" data-src="./assets/images/review_bg_1.png">
		<div class="container">
			<div class="section-heading section-heading--center" data-aos="fade">
				<h2 class="__title">Voila ce dont les gens pense <span>à propos d'agridev</span></h2>
				...
				<div class="js-slick" data-slick='{"autoplay": true, "arrows": false, "dots": true, "speed": 1000}'>
					...
					<div class="review__item">
						<div class="review__item__text">
							<p>
								<i>Latin words, combined with a handful of model sentence structures, to
									...
									words etc. Contrary to popular belief, Lorem Ipsum is not simply random
						...
						<div class="review__item__author  d-table">
							<div class="d-table-cell align-middle">
								<div class="review__item__author-image">
									<img class="circled" src="./assets/images/ava.png" alt="ava" />
								</div>
							</div>
		...
		<div class="simple-banner simple-banner--style-1" data-aos="fade" data-aos-offset="50">
			...
			<div class="container">
				<div class="row">
					<div class="col-12">
						<div class="__inner">
							<img class="img-fluid  lazy" src="./assets/images/blank.gif" data-src="./assets/images/site_logo.png" alt="demo" />

							<div class="row">
								<div class="col-12 col-lg-7 col-xl-5">
									<div class="banner__text" data-aos="fade-left" data-delay="500">
										<h2 class="__title h1"><b style="display: block; color: #c6c820;">Fruits et legumes
											</b> <span>Disponible dans notre boutique</span></h2>

										<p>
											<h2 style="color: red">Arrivera BIENTÔT.</h2>
										</p>
		...
		<div class="container">
			<div class="partners-list">
				<div class="js-slick" data-slick='{
					...
					<div class="__item">
						<img class="img-fluid m-auto" src="./assets/images/partners_img/1.jpg" alt="demo" />
					</div>

					<div class="__item">
						<img class="img-fluid m-auto" src="./assets/images/partners_img/2.jpg" alt="demo" />
					</div>

					<div class="__item">
						<img class="img-fluid m-auto" src="./assets/images/partners_img/3.jpg" alt="demo" />
					</div>

					<div class="__item">
						<img class="img-fluid m-auto" src="./assets/images/partners_img/4.jpg" alt="demo" />
					</div>

					<div class="__item">
						<img class="img-fluid m-auto" src="./assets/images/partners_img/5.jpg" alt="demo" />
					</div>
				</div>
			</div>
		</div>
